    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('CHU', 'Centre Hospitalier Universitaire'), ('CHR', 'Centre Hospitalier Régional'), ('HOSPITAL', 'Hôpital Général'), ('CS', 'Centre de Santé'), ('LAB', 'Laboratoire'), ('PHARMA', 'Pharmacie')], default='HOSPITAL', max_length=32)),
                ('active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('idp_sub', models.CharField(db_index=True, max_length=128, unique=True)),
                ('username', models.CharField(db_index=True, max_length=150)),
                ('email', models.EmailField(blank=True, max_length=254, null=True)),
                ('phone', models.CharField(blank=True, max_length=32, null=True)),
                ('tenant_key', models.CharField(blank=True, max_length=64, null=True)),
                ('scope_level', models.CharField(default='SERVICE', max_length=20)),
                ('departments', models.JSONField(blank=True, default=list)),
                ('patient_mpi', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.AddField(
            model_name='facility',
            name='district',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='hospital.district'),
        ),
        migrations.AddField(
            model_name='facility',
            name='parent',
        ...
        migrations.AddField(
            model_name='facility',
            name='region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='hospital.region'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='facility',
            index=models.Index(fields=['type'], name='hospital_fa_type_f40efe_idx'),
        ),
        migrations.AddIndex(
            model_name='facility',
        ...
        migrations.AddIndex(
            model_name='facility',
            index=models.Index(fields=['region'], name='hospital_fa_region__7b6012_idx'),
        ),
        migrations.AddIndex(
            model_name='facility',
            index=models.Index(fields=['district'], name='hospital_fa_distric_6e19a3_idx'),
        ),
        migrations.AddIndex(
            model_name='facility',
        ...
        migrations.AddConstraint(
            model_name='facility',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('is_chu', True), _negated=True), ('type', 'CHU'), _connector='OR'), name='facility_chu_implies_type_chu'),
        ),
        migrations.AddConstraint(
            model_name='facility',
